...
[English README](README.md) · [最新 V4.3 源码与固件](v4.3/) · [原始接线图](figures/Esp32c3_supermini_wiring.png) · [图片归档](figures/README.md)
...
原始接线图仍作为主要接线参考。上电前请根据实际控制板确认电平、共地和引脚标记。
...
V3.0 与 V3.1 的原有截图均已保留在仓库中。

![V3.1 网页](figures/v3.1.png)

![V3.0 网页](figures/v3.0.png)
